...
entity conv2d_3x3_fifo_w80_d2_S is 
    generic (
...
architecture rtl of conv2d_3x3_fifo_w80_d2_S is

    component conv2d_3x3_fifo_w80_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 80;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_conv2d_3x3_fifo_w80_d2_S_ShiftReg : conv2d_3x3_fifo_w80_d2_S_ShiftReg
    generic map (
...
entity conv2d_3x3_fifo_w80_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 80;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end conv2d_3x3_fifo_w80_d2_S_ShiftReg;

architecture rtl of conv2d_3x3_fifo_w80_d2_S_ShiftReg is
